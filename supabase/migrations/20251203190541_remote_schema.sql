...
CREATE OR REPLACE VIEW "public"."community_characters" WITH ("security_invoker"='on') AS
 SELECT "id",
    "name",
    "personality",
    "sex",
    ...
    COALESCE(( SELECT "count"(*) AS "count"
          ...
          WHERE ("cf"."character_id" = "c"."id")), (0)::bigint) AS "favorite_count",
    COALESCE(( SELECT "count"(*) AS "count"
           FROM "public"."character_comments" "cc"
          WHERE (("cc"."character_id" = "c"."id") AND ("cc"."is_deleted" = false))), (0)::bigint) AS "comment_count"
   FROM "public"."characters" "c"
  WHERE ("is_public" = true)
  ORDER BY "published_at" DESC;


ALTER VIEW "public"."community_characters" OWNER TO "postgres";
